def main():
    ...
    #Note: this test works on the assumption that all the persmissions are turned on
    ...
    system = driver.find_element_by_xpath("(//android.view.View[@content-desc=\"On\"])[1]") 
    nearContacts = driver.find_element_by_xpath("(//android.view.View[@content-desc=\"On\"])[2]")
