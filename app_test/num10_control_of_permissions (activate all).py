def main():
    ...
    #1 definition:
    bars = driver.find_element_by_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[1]/android.view.View[2]")
    ...
    time.sleep(2)
    control = driver.find_element_by_accessibility_id("Control de permisos")
    control.click()
    time.sleep(3)

    #definitions inside control permissions (can currently be seen on the screen)
    gps = driver.find_element_by_xpath("(//android.view.View[@content-desc=\"Off\"])[1]")
    camera = driver.find_element_by_xpath("(//android.view.View[@content-desc=\"Off\"])[2]")
    iotDevice = driver.find_element_by_xpath("(//android.view.View[@content-desc=\"Off\"])[3]")
    ...
    system = driver.find_element_by_xpath("(//android.view.View[@content-desc=\"Off\"])[1]") 
    nearContacts = driver.find_element_by_xpath("(//android.view.View[@content-desc=\"Off\"])[2]")
